...
def visualization(df,logger):
    try:
        ...
        ax=sns.countplot(data=df, x='Churn', hue='Churn', palette='Greens')
        ...
        #telecom_partner vs gender
        plt.figure(figsize=(10,6))
        ax=sns.countplot(data=df, x='telecom_partner', hue='gender', palette='YlGn')
        ...
        # SeniorCitizen distribution in Telecom Partners
        plt.figure(figsize=(10, 6))
        ...
        #Gender vs Churn (To see if gender affects retention)
        plt.figure(figsize=(8, 5))
        ax=sns.countplot(data=df, x='gender', hue='Churn', palette='Oranges')
        ...
        #Gender Breakdown for Customers with No Internet Service
        plt.figure(figsize=(8, 6))
        ax=sns.countplot(x='gender', data=df.query("InternetService == 'No'"), palette=['skyblue', 'salmon'], edgecolor='black')
        ...
        # Tenure vs Churn
        plt.figure(figsize=(10, 6))
        ax=sns.histplot(data=df, x='tenure', hue='Churn', kde=True, palette='BuGn', element='step')
        ...
        ax=sns.barplot(data=contract_churn, x='Contract', y='Count', hue='Churn', palette='YlGn')
        ...
        ax=sns.barplot(data=internet_churn, x='InternetService', y='Count', hue='Churn', palette='Greys')
        ...
        ax=sns.barplot(data=payment_churn, x='PaymentMethod', y='Count', hue='Churn', palette='Greens')
        ...
        plt.figure(figsize=(8, 5))
        ax=sns.countplot(data=df, x='SeniorCitizen', hue='Churn', palette='Greys_r')
        ...
        #Senior Citizens within each Gender
        plt.figure(figsize=(8, 5))
        ax=sns.countplot(data=df, x='gender', hue='SeniorCitizen', palette=['skyblue', 'orange'])
